...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/css/main.css') }}?166828781424">
...
<body>
    ...
    <div class="centered-logo justify-content-center text-center align-items-center" style="height: 60px;margin: 0 0 8px 0;">
        <img src="{{ asset('assets/images/logo/logo-black-gd.png') }}" alt="Koverae POS" class="navbar-brand-image" style="height: 50px">
    </div>
