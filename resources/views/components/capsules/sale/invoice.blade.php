...
<div class="form-check k_radio_item" id="capsule">
    ...
    <a style="text-decoration: none;" title="{{ $value->help }}" wire:navigate href="{{ route('sales.invoices.show', ['subdomain' => current_company()->domain_name, 'sale' => $sale->id, 'invoice' => $sale->invoice->id]) }}" >
