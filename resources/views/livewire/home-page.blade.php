            ...
            <div class="row bg-white app_list">
                ...
                <div class="app col-6 col-lg-3 mb-3 pt-1 pb-1 cursor-pointer">
                    <div class="d-flex gap-1">
                        <a href="{{ route($module->link, ['subdomain' => current_company()->domain_name, 'menu' => current_menu()]) }}" class="text-decoration-none"  wire:click.prevent="openApp({{ $app->module->id }})"   wire:target="openApp({{ $app->module->id }})">
                            <img src="{{ asset('assets/images/apps/'.$app->module->icon.'.png') }}" height="40px" width="40px" alt="" class="app_icon rounded">
                        </a>
                        <a href="{{ route($module->link, ['subdomain' => current_company()->domain_name, 'menu' => current_menu()]) }}" class="text-decoration-none font-weight-bold"  wire:click.prevent="openApp({{ $app->module->id }})"   wire:target="openApp({{ $app->module->id }})">
