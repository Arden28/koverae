...
class IncotermPanel extends ControlPanel
{
    ...
    public function mount()
    {
        ...
        $this->currentPage = __('translator::invoicing.control.incoterm.current_page_list');
        // $this->new = route('invoices.incoterms.create', parameters: ['subdomain' => current_company()->domain_name, 'menu' => current_menu()]);
    }
