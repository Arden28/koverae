...
{
    public $employee, $name, $jobTitle, $phone, $mobile, $email, $society, $department, $manager, $job;
    ...
    {
        $page = $request->query('epID');
        return view('employee::livewire.employees.show')->layout('layouts.master');
    }
