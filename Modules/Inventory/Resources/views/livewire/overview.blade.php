                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row g-2 align-items-center">
                                ...
                                <div class="col-auto">
                                    <a wire:navigate href="{{ route('inventory.operation-transfers.index', ['subdomain' => current_company()->domain_name, 'type' => $o->id,'status' => 'ready', 'menu' => current_menu()]) }}" class="btn btn-primary">
