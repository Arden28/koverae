        ...
        <table class="table card-table table-vcenter text-nowrap datatable">
            ...
            <tbody>
                ...
                <tr class="k_field_list_row">
                    ...
                    <td class="k_field_list">
                        <input type="text" wire:model.blur="inputs.{{ $key }}.description" class="k_input" id="cart-input">
                    </td>
                    <td class="k_field_list">
                        <input type="datetime-local" wire:model.blur="inputs.{{ $key }}.schedule_date" class="k_input" id="cart-input">
                    </td>
                    <td class="k_field_list">
                        <input type="datetime-local" wire:model.blur="inputs.{{ $key }}.deadline_date" class="k_input">
                    </td>
                    <td class="k_field_list">
                        <input type="number" wire:model.blur="inputs.{{ $key }}.demand" class="k_input">
                    </td>
                    {{-- <td class="k_field_list">
