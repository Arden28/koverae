                ...
                <div class="dropdown-menu-column">
                    <div class="dropend">
                        ...
                        <div class="dropdown-menu">
                          ...
                          <a wire:navigate href="{{ route('inventory.operation-transfers.index', ['subdomain' => current_company()->domain_name, 'type' => 'manufacturing', 'menu' => current_menu()]) }}" class="dropdown-item">
                            {{ __('Fabrications') }}
                          </a>
                          @endif
                        </div>
