...
class BankPanel extends ControlPanel
{
    ...
    public function mount()
    {
        ...
        $this->currentPage = __('translator::contacts.control.bank.current_page_list');
        $this->new = route('contacts.banks.create', parameters: ['subdomain' => current_company()->domain_name, 'menu' => current_menu()]);
