<div>
    ...
    <div wire:loading class="card position-absolute mt-1 border-0" style="z-index: 1;left: 0;right: 0; width: 25%;">
    ...
    @if(!empty($query))
        <div wire:click="resetQuery" class="position-fixed h-100" style="left: 0; top: 0; right: 0; bottom: 0;z-index: 1; width: 25%;"></div>
        @if($search_results->isNotEmpty())
            <div class="card position-absolute mt-1" style="z-index: 2;left: 0;right: 0;border: 0; width: 25%;">
                <div class="card-body shadow">
                    <ul class="list-group list-group-flush">
                        @foreach($search_results as $result)
                            <li class="list-group-item list-group-item-action">
                                <a wire:click="resetQuery" wire:click.prevent="selectContact({{ $result }})" href="#">
                                    {{ $result->name }}
                                </a>
                            </li>
                        @endforeach
