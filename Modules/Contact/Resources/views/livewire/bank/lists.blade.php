                    ...
                    <div class="card">
                        ...
                        <div class="k_control_panel_main d-flex flex-wrap flex-grow-2 flex-nowrap justify-content-between align-items-start gap-5">
                            ...
                            <div class="k_control_panel_breadcumbs d-flex align-items-center gap-1 order-0 h-lg-100">
                                <a wire:navigate href="{{ route('contacts.banks.create', ['subdomain' => current_company()->domain_name ]) }}" class="btn btn-outline-primary k_form_button_create">
                                    {{ __('Nouveau') }}
                                </a>
                        ...
                        <table class="table card-table table-vcenter text-nowrap datatable">
                            ...
                            <tr>
                                ...
                                <th><button class="table-sort" data-sort="sort-name">{{ __("Code d'identifiant bancaire") }}</button></th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a style="text-decoration: none" wire:navigate href="{{ route('contacts.banks.show', ['tag' => $b->id, 'subdomain' => current_company()->domain_name]) }}"  tabindex="-1">
                                            {{ $b->name }}
                                        </a>
                                    </td>
                                    <td>
