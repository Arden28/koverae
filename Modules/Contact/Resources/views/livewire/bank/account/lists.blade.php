                    ...
                    <div class="card">
                        ...
                        <div class="k_control_panel_main d-flex flex-wrap flex-grow-2 flex-nowrap justify-content-between align-items-start gap-5">
                            ...
                            <div class="k_control_panel_breadcumbs d-flex align-items-center gap-1 order-0 h-lg-100">
                                <a wire:navigate href="{{ route('contacts.banks.accounts.create', ['subdomain' => current_company()->domain_name ]) }}" class="btn btn-outline-primary k_form_button_create">
                                    {{ __('Nouveau') }}
                                </a>
                        ...
                        <table class="table card-table table-vcenter text-nowrap datatable">
                            ...
                            <tr>
                                ...
                                <th><button class="table-sort" data-sort="sort-name">{{ __("Titulaire du compte") }}</button></th>
                                <th></th>
                            </tr>
                            </thead>
                            <tbody>
                                ...
                                <tr>
                                    <td><input value="{{ $b->id }}" class="form-check-input m-0 align-middle" type="checkbox" aria-label="Select invoice"></td>
                                    <td>
                                        <a style="text-decoration: none" wire:navigate href="{{ route('contacts.banks.accounts.show', ['tag' => $b->id, 'subdomain' => current_company()->domain_name]) }}"  tabindex="-1">
                                            {{ $b->name }}
                                        </a>
                                    </td>
                                    <td>
                                    ...
                                    <td class="text-end">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            ...
                                            <a href="#" wire:click="selectedId({{ $b->id }})" data-bs-toggle="modal" data-bs-target="#employee-{{ $b->id }}" class="dropdown-item text-danger">
                                                {{ __('Supprimer') }}
                                            </a>
                                        </div>
                                        </span>
                                ...
                                <!-- Delete Modal -->
                                <div wire:ignore class="modal modal-blur fade" id="employee-{{ $b->id }}" tabindex="-1" role="dialog" aria-hidden="true">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <h3>{{ __("Êtes vous sûr de vouloir supprimer le devis ". $b->reference.' ?') }}</h3>
                                        ...
                                        <div class="w-100">
                                            ...
                                            <div class="col"><a wire:click.prevent="delete({{ $b->id }})" class="btn btn-danger w-100" data-bs-dismiss="modal">
                                                {{ __('Supprimer') }}
                                                </a></div>
                                            </div>
                                        </div>
