                    ...
                    <div class="card">
                        ...
                        <div class="k_control_panel_main d-flex flex-wrap flex-grow-2 flex-nowrap justify-content-between align-items-start gap-5">
                            ...
                            <div class="k_control_panel_breadcumbs d-flex align-items-center gap-1 order-0 h-lg-100">
                                <a wire:navigate href="{{ route('contacts.tags.create', ['subdomain' => current_company()->domain_name ]) }}" class="btn btn-outline-primary k_form_button_create">
                                    {{ __('Nouveau') }}
                                </a>
                        ...
                        <table class="table card-table table-vcenter text-nowrap datatable">
                            ...
                            <tr>
                                ...
                                <th><button class="table-sort" data-sort="sort-name">{{ __('Couleur') }}</button></th>
                                <th></th>
                            </tr>
                            </thead>
                            <tbody>
                                @foreach($tags as $t)
                                <tr>
                                    <td><input wire:model.blur="selectedEmployees" value="{{ $t->id }}" class="form-check-input m-0 align-middle" type="checkbox" aria-label="Select invoice"></td>
                                    <td>
                                        <a style="text-decoration: none" wire:navigate href="{{ route('contacts.tags.show', ['tag' => $t->id, 'subdomain' => current_company()->domain_name]) }}"  tabindex="-1">
                                            {{ $t->name }}
                                        </a>
                                    </td>
                                    <td>
                                        <span style="height: 17vh; width: 25px; border: 1px solid #fff; background-color: {{ $t->color }}">
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        </span>
                                    </td>
                                    <td class="text-end">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            ...
                                            <a href="#" wire:click="selectedId({{ $t->id }})" data-bs-toggle="modal" data-bs-target="#employee-{{ $t->id }}" class="dropdown-item text-danger">
                                                {{ __('Supprimer') }}
                                            </a>
                                        </div>
                                        </span>
                                ...
                                <!-- Delete Modal -->
                                <div wire:ignore class="modal modal-blur fade" id="employee-{{ $t->id }}" tabindex="-1" role="dialog" aria-hidden="true">
