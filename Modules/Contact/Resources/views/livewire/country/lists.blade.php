                    ...
                    <div class="card">
                        ...
                        <table class="table card-table table-vcenter text-nowrap datatable">
                            ...
                            <tr>
                                ...
                                <th><button class="table-sort" data-sort="sort-name">{{ __('Code') }}</button></th>
                            </tr>
                            </thead>
                            <tbody>
                                @foreach($countries as $c)
                                <tr>
                                    <td><input  value="{{ $c->id }}" class="form-check-input m-0 align-middle" type="checkbox" aria-label="Select invoice"></td>
                                    <td>
                                        <a style="text-decoration: none" wire:navigate href="{{ route('contacts.countries.show', ['contact' => $c->id, 'subdomain' => current_company()->domain_name]) }}"  tabindex="-1">
                                            {{ $c->name }}
                                        </a>
                                    </td>
                                    <td>
