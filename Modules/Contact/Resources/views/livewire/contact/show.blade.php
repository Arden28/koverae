...
<div>
    <div class="k_form_sheet_bg">
        ...
        <form wire:submit.prevent="updateContact({{$contact->id}})">
            @csrf
            <!-- Status bar -->
                    ...
                    <div class="ke_title mw-75 pe-2 ps-0">
                        ...
                        <div class="k_horizontal">
                            ...
                            <div class="form-check k_radio_item" wire:dirty>
                                <button type="submit" wire:target="updateContact({{$contact->id}})" title="Sauvegarder les changements...."><i class="bi bi-cloud-arrow-up-fill fa-xs" style="font-size: 19px;"></i></button>
                            </div>
