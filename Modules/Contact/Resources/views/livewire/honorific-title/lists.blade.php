                  ...
                  <div class="card">
                    <div class="k_control_panel_main d-flex flex-wrap flex-grow-2 flex-nowrap justify-content-between align-items-start gap-5">
                        ...
                        <div class="k_control_panel_breadcumbs d-flex align-items-center gap-1 order-0 h-lg-100">
                            <a wire:click="$set('addTitle', true)" class="btn btn-outline-primary k_form_button_create">
                                {{ __('Nouveau') }}
                            </a>
                ...
                <div class="table-responsive">
                  <table class="table card-table table-vcenter text-nowrap datatable">
                    ...
                    <tbody>
                        @foreach($titles as $t)
                        <tr>
                            <td><input wire:model.blur="selectedTitles" value="{{ $t->id }}" class="form-check-input m-0 align-middle" type="checkbox" aria-label="Select invoice"></td>
                            <td>
                                {{ $t->title }}
                            </td>
                            <td>
                        ...
                        <!-- Add Title -->
                        @if($addTitle)
                        <form wire:submit="storeTitle()" wire:transition>
                            @csrf
                            <tr>
                                <td><input wire:model="selectedTitles" class="form-check-input m-0 align-middle" type="checkbox" aria-label="Select invoice"></td>
                                <td>
                                    <input type="text" class="k_input" wire:model="title">
                                </td>
                                <td>
                                    <input type="text" class="k_input" wire:model="abbreviation">
                                </td>
                                <td>
                                    <button type="submit"wire:click="storeTitle()">{{ __('Sauvegrader') }}</button>
                                </td>
                            </tr>
                        </form>
                        @endif
