...
<li class="nav-item dropdown" data-turbolinks>
    ...
    <div class="dropdown-menu">
        <div class="dropdown-menu-columns">
            <!-- Left Side -->
            <div class="dropdown-menu-column">
                <a class="dropdown-item" wire:navigate href="{{ route('purchases.products.index', ['subdomain' => current_company()->domain_name]) }}">
                    {{ __('Produits') }}
                </a>
            </div>
        </div>
        ...
        <div class="dropdown-menu-columns">
            ...
            <div class="dropdown-menu-column">
                ...
                <div class="dropend">
                    ...
                    <div class="dropdown-menu">
                      <a wire:navigate href="{{ route('purchases.products.categories.index', ['subdomain' => current_company()->domain_name]) }}" class="dropdown-item">
