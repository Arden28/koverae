...
class PurchaseForm extends BaseForm
{
    ...
    public function mount ($purchase = null){
        if($purchase){
            ...
            $this->deadline_date = $purchase->deadline_date;
            $this->expected_arrival_date = $purchase->expected_arrival_date;
    ...
    public function inputs() : array
    {
        return  [
            ...
            Input::make('expected_arrival_date','Arrivée prévue', 'date', 'expected_arrival_date', 'right', 'none', 'none'),
