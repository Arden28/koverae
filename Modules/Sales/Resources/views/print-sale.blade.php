                ...
                <tr>
                    ...
                    <td class="border-0 pl-0" width="50%">
                        <h4 class="text-uppercase cool-gray">
                            <strong>{{ __('Devis') }} # {{ $sale->reference }}</strong>
                        </h4>
                        <p>{{ __('Date du devis') }}: <strong>{{ \Carbon\Carbon::parse($sale->date)->format('d/m/Y') }}</strong></p>
                        <p>{{ __("Date d'échéance") }}: <strong>{{ \Carbon\Carbon::parse($sale->expected_date)->format('d/m/Y') }}</strong></p>
