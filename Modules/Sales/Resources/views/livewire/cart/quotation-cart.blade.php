    ...
    <div class="table-responsive card">
        <table class="table card-table text-nowrap">
            <thead class="order-table">
                <tr class="order-tr">
                    <th><button class="table-sort">{{ __('translator::sales.form.quotation.cart.product') }}</button></th>
                    <th><button class="table-sort">{{ __('translator::sales.form.quotation.cart.description') }}</button></th>
                    <th><button class="table-sort">{{ __('translator::sales.form.quotation.cart.quantity') }}</button></th>
                    <th><button class="table-sort">{{ __('translator::sales.form.quotation.cart.price') }}</button></th>
                    <th><button class="table-sort">{{ __('translator::sales.form.quotation.cart.wt') }}</button></th>
                    <th></th>
                </tr>
            </thead>
            <tbody>
