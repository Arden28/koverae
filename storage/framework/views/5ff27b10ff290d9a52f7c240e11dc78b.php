...
<li class="nav-item dropdown" data-turbolinks>
    ...
    <div class="dropdown-menu">
        <div class="dropdown-menu-columns">
            <!-- Left Side -->
            <div class="dropdown-menu-column">
                <a class="dropdown-item" wire:navigate href="<?php echo e(route('purchases.products.index', ['subdomain' => current_company()->domain_name])); ?>">
                    <?php echo e(__('Produits')); ?>
        ...
        <div class="dropdown-menu-columns">
            ...
            <div class="dropdown-menu-column">
                ...
                <div class="dropend">
                    ...
                    <div class="dropdown-menu">
                      <a wire:navigate href="<?php echo e(route('purchases.products.categories.index', ['subdomain' => current_company()->domain_name])); ?>" class="dropdown-item">
