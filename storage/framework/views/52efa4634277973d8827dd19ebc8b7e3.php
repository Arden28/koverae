                ...
                <div class="k_field_widget k_field_text k_read_only modify w-auto ps-3 text-muted" data-bs-toggle="tooltip" data-bs-placement="right" title="Cette valeur est appliquée par défaut sur tous les nouveaux produits. Ceci peut être modifié dans la fiche du produit.">
                    ...
                    <div>
                        <div class="form-check k_radio_item">
                            <input type="radio" class="form-check-input k_radio_input" wire:model.live="<?php echo e($value->model); ?>" name="<?php echo e($value->model); ?>" id="ordered" value="ordered"/>
                            <label class="form-check-label k_form_label" for="ordered">
                                <?php echo e(__('Quantité commandées')); ?>
                    ...
                    <div>
                        <div class="form-check k_radio_item">
                            <input type="radio" class="form-check-input k_radio_input" wire:model.live="<?php echo e($value->model); ?>" name="<?php echo e($value->model); ?>" id="delivered" value="delivered"/>
                            <label class="form-check-label k_form_label" for="delivered">
                                <?php echo e(__('Quantité reçues')); ?>
...
<?php /**PATH C:\wamp64\www\my-startups\app.koverae\resources\views/components/blocks/boxes/ratio/bill-policy.blade.php ENDPATH**/ ?>