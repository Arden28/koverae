...
<div class="d-flex" style="margin-bottom: 8px;">
    ...
    <div class="k_cell k_wrap_input flex-grow-1">
        ...
        <button type="button" class="btn btn-link">
             <?php echo e(__('Afficher')); ?> <span wire:loading wire:target="generateCypher">...</span>
        </button>
...
<?php /**PATH C:\wamp64\www\my-startups\app.koverae\resources\views/components/inputs/pin_code.blade.php ENDPATH**/ ?>