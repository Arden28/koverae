            ...
            <!--[if BLOCK]><![endif]--><?php if($this->sales_taxes): ?>
                ...
                <span class="w-auto k_tag d-inline-flex align-items-center badge rounded-pill k_tag_color_0">
                    <div class="k_tag_badge_text text-truncate">
                        ...
                        <a wire:click="removeSaleTax('<?php echo e($tax->id); ?>')" wire:tagert="removeSaleTax('<?php echo e($tax->id); ?>')" class="opacity-75 cursor-pointer k_delete opacity-100-hover ps-1">
...
<?php /**PATH D:\My Laravel Project\koverae-app\resources\views/components/inputs/tag/sale_taxes.blade.php ENDPATH**/ ?>