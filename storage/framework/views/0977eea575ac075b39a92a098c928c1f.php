<div>
    <div class="modal-content">
      ...
      <div class="modal-body">
        <!--[if BLOCK]><![endif]--><?php if(count($this->inputs()) >= 1): ?>
        <div class="k_form_nosheet">
            ...
            <!--[if BLOCK]><![endif]--><?php if($input->position == 'top' && $input->tab == 'none'): ?>
...
<?php endif; ?>
      ...
      <div class="p-0 modal-footer">
            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $this->buttons(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $button): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php if (isset($component)) { $__componentOriginal511d4862ff04963c3c16115c05a86a9d = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal511d4862ff04963c3c16115c05a86a9d = $attributes; } ?>
<?php $component = Illuminate\View\DynamicComponent::resolve(['component' => $button->component] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('dynamic-component'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\DynamicComponent::class))->getConstructor()): ?>
...
<?php /**PATH D:\My Laravel Startup\koverae\Modules/App\Resources/views/livewire/components/modal/base-modal.blade.php ENDPATH**/ ?>