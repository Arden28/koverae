...
<html lang="fr">
    <head>
        ...
        <title><?php echo e(__('Bon de commande fournisseur')); ?> - <?php echo e($purchase->reference); ?> | <?php echo e(current_company()->name); ?></title>
        <!-- Favicon -->
    ...
    <body>
                ...
                <tr>
                    <td class="border-0 pl-0" width="70%">
                        ...
                        <?php if(current_company()->address): ?>
                            <p class="company-address">
                                <?php echo e(__('Adresse de livraison')); ?>: <?php echo e(current_company()->address); ?>
                        ...
                        <?php if(current_company()->country): ?>
                            <p class="company-country">
                                <?php echo e(__('Adresse')); ?>: <?php echo e(current_company()->country); ?>
                    ...
                    <td class="border-0 pl-0" width="60%">
                        <h4 class="text-uppercase cool-gray">
                            <strong><?php echo e(__('Commande')); ?> <?php echo e($purchase->reference); ?></strong>
                        </h4>
                        <p><b><?php echo e(__('Date de la commande')); ?></b>: <strong><?php echo e(\Carbon\Carbon::parse($purchase->date)->format('d/m/Y')); ?></strong></p>
                        <p><b><?php echo e(__("Responsable achat")); ?></b>: <?php echo e($buyer->user->name); ?></p>
                    </td>
                </tr>
            </tbody>
        </table>
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <table class="table table-items">
                    <thead>
                        <tr>
                            ...
                            <?php if($purchase->product_discount_percentage): ?>
                                <th scope="col" class="text-right border-0"><?php echo e(__('Réduction')); ?></th>
                            <?php endif; ?>
                            <?php if($purchase->tax_percentage): ?>
                    ...
                    <tbody>
                        ...
                        <tr style="border-bottom: 1px solid #dee2e6;">
                            ...
                            <?php if($purchase->product_discount_amount): ?>
                                <td class="text-right">
                        ...
                        <?php if($purchase->discount_amount > 0): ?>
                            <tr>
                                <td colspan="<?php echo e($purchase->table_columns - 2); ?>" class="border-0"></td>
                                <td colspan="<?php echo e($purchase->table_columns - 2); ?>" class="border-0"></td>
                                <td colspan="<?php echo e($purchase->table_columns - 2); ?>" class="border-0"></td>
                                <td class="text-right pl-0"><?php echo e(__('Réduction')); ?> (<?php echo e($purchase->discount_percentage); ?>)%</td>
                                <td class="text-right pr-0">
                        ...
                        <?php if($purchase->tax_amount > 0): ?>
                            <tr>
                                ...
                                <td colspan="<?php echo e($purchase->table_columns - 2); ?>" class="border-0"></td>
                                <td colspan="<?php echo e($purchase->table_columns - 2); ?>" class="border-0"></td>
                                <td class="text-right pl-0"><?php echo e(__('Taxe')); ?>  (<?php echo e($purchase->tax_percentage); ?>%)</td>
                                <td class="text-right pr-0">
                                    <?php echo e(format_currency($purchase->tax_amount)); ?>

                                </td>
                            </tr>
                        <?php endif; ?>
                        <?php if($purchase->tax_rate): ?>
                            <tr>
                                <td colspan="<?php echo e($purchase->table_columns - 2); ?>" class="border-0"></td>
                                <td colspan="<?php echo e($purchase->table_columns - 2); ?>" class="border-0"></td>
                                <td colspan="<?php echo e($purchase->table_columns - 2); ?>" class="border-0"></td>
                                <td class="text-right pl-0"><?php echo e(__('purchases::purchase.tax_rate')); ?></td>
                                <td class="text-right pr-0">
                                    <?php echo e($purchase->tax_percentage); ?>%
                                </td>
                            </tr>
                        <?php endif; ?>
                        <?php if($purchase->shipping_amount > 0): ?>
                            <tr>
                                <td colspan="<?php echo e($purchase->table_columns - 2); ?>" class="border-0"></td>
                                <td colspan="<?php echo e($purchase->table_columns - 2); ?>" class="border-0"></td>
                                <td colspan="<?php echo e($purchase->table_columns - 2); ?>" class="border-0"></td>
                                ...
                                <td class="text-right pr-0">
                                    <?php echo e(format_currency($purchase->shipping_amount)); ?>
                        ...
                        <?php endif; ?>
                            <tr>
                                ...
                                <td class="text-right pr-0">
                                    <?php echo e(format_currency($purchase->total_amount)); ?>
                ...
                <?php if($purchase->term): ?>
                    <p>
                        <?php echo e(__('Notes')); ?>: <?php echo $purchase->term; ?>
                ...
                <p>
                    Veuillez utiliser cette reference pour votre paiement: <?php echo e($purchase->reference); ?>

                </p>
                <p>
                    Modalité de paiement: <?php echo e($purchase->payment_term); ?>

                </p>
                <?php if($purchase->shipping_date): ?>
                <p>
                    Date de livraison prévue: <?php echo e(\Carbon\Carbon::parse($purchase->shipping_date)->format('d/m/Y')); ?>
...
<?php /**PATH C:\wamp64\www\my-startups\app.koverae\Modules/Purchase\Resources/views/print-purchase-order.blade.php ENDPATH**/ ?>