...
<div class="d-flex" style="margin-bottom: 8px;">
    ...
    <div class="k_cell k_wrap_input flex-grow-1">
        ...
        <?php else: ?>
        <input type="<?php echo e($value->type); ?>" wire:model.blur="<?php echo e($value->model); ?>" class="k_input" placeholder="<?php echo e($value->placeholder); ?>" id="date_0" <?php echo e($this->blocked ? 'disabled' : ''); ?>>
