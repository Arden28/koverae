...
$__html = app('livewire')->mount($__name, $__params, 'lw-11856219-0', $__slots ?? [], get_defined_vars());
        ...
        <header class="navbar navbar-expand-md navbar-light d-print-none">
            <div class="container-fluid">
                ...
                <h1 class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
                    <a href="">
                        <img src="<?php echo e(asset('assets/images/logo/logo-black.png')); ?>" alt="Koverae Logo" class="navbar-brand-image">
                    </a>
                </h1>
                <div class="flex-row navbar-nav order-md-last">
                        ...
                        <div class="nav-item dropdown d-none d-md-flex me-3">
                            ...
                            <div class="dropdown-menu dropdown-menu-arrow dropdown-menu-end dropdown-menu-card">
                                <div class="card">
                                    ...
                                    <button class="border-0 nav-link active" id="nav-home-tab" data-bs-toggle="tab" data-bs-target="#nav-home" type="button" role="tab" aria-controls="nav-home" aria-selected="true"><?php echo e(__('All')); ?></button>
                                    <button class="border-0 nav-link" id="nav-profile-tab" data-bs-toggle="tab" data-bs-target="#nav-profile" type="button" role="tab" aria-controls="nav-profile" aria-selected="false"><?php echo e(__('Chats')); ?></button>
                                    <button class="border-0 nav-link" id="nav-contact-tab" data-bs-toggle="tab" data-bs-target="#nav-contact" type="button" role="tab" aria-controls="nav-contact" aria-selected="false"><?php echo e(__('Channel')); ?></button>
                                    </div>
                                    <div class="tab-content" style="width: 500px;">
                                        ...
                                        <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                                            <div class="list-group list-group-flush list-group-hoverable">
                                                ...
                                                <div class="list-group-item">
                                                    <div class="row align-items-center">
                                                        <img src="<?php echo e(asset('assets/images/kwame-bot/kwame-2.svg')); ?>" class=" rounded-circle" style="width: 70px; height: 70px;" alt="image">
                                                        <div class="col text-truncate">
                                                            <a href="#" class="text-body d-block">Example 1</a>
                                                            <div class="d-block text-muted text-truncate mt-n1">
                                                                Change deprecated html tags to text decoration classes (#29604)
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                            ...
                            <a href="#" class="dropdown-item divider"><?php echo e(__('Support')); ?></a>
                            <a href="#" class="dropdown-item"><?php echo e(__('Dark Mode')); ?></a>
                            <hr class="dropdown-divider">
                            <a href="#" class="dropdown-item"><?php echo e(__('My Preferences')); ?></a>
                            <a href="#" class="dropdown-item"><?php echo e(__('My Databases')); ?></a>
                            <a href="#" class="dropdown-item"><?php echo e(__('My Subscription')); ?></a>
                            <hr class="dropdown-divider">
                            <a href="#" class="dropdown-item"><?php echo e(__('Install the App')); ?></a>
                            <!-- Authentication -->
...
<?php /**PATH D:\My Laravel Startup\koverae\resources\views/layouts/main.blade.php ENDPATH**/ ?>