...
<li class="nav-item">
    <a class="nav-link kover-navlink" style="margin-right: 5px;" wire:navigate href="<?php echo e(route('inventory.index', ['subdomain' => current_company()->domain_name])); ?>" >
      <span class="nav-link-title">
        ...
        <div class="dropdown-menu-columns">
            ...
            <div class="dropdown-menu-column">
                <div class="dropend">
                    ...
                    <div class="dropdown-menu">
                      <a wire:navigate href="<?php echo e(route('inventory.operation-transfers.index', ['subdomain' => current_company()->domain_name])); ?>" class="dropdown-item">
                ...
                <div class="dropend">
                    ...
                    <div class="dropdown-menu">
                        <a wire:navigate href="<?php echo e(route('inventory.adjustments.physical.index', ['subdomain' => current_company()->domain_name])); ?>" class="dropdown-item">
                            <?php echo e(__('Inventaire physique')); ?>

                        </a>
                        <a wire:navigate href="<?php echo e(route('inventory.adjustments.scraps.index', ['subdomain' => current_company()->domain_name])); ?>" class="dropdown-item">
...
<li class="nav-item dropdown" data-turbolinks>
    ...
    <div class="dropdown-menu">
        <div class="dropdown-menu-columns">
            <!-- Left Side -->
            <div class="dropdown-menu-column">
                <a class="dropdown-item" wire:navigate href="<?php echo e(route('inventory.products.index', ['subdomain' => current_company()->domain_name])); ?>">
                    <?php echo e(__('Produits')); ?>
...
<li class="nav-item dropdown" data-turbolinks>
    ...
    <div class="dropdown-menu">
        <div class="dropdown-menu-columns">
            <!-- Left Side -->
            <div class="dropdown-menu-column">
                <a class="dropdown-item" wire:navigate href="<?php echo e(route('settings.general', ['subdomain' => current_company()->domain_name, 'view' => 'inventory'])); ?>">
                ...
                <div class="dropend">
                    ...
                    <div class="dropdown-menu">
                      <a wire:navigate href="<?php echo e(route('inventory.warehouses.index', ['subdomain' => current_company()->domain_name])); ?>" class="dropdown-item">
                        <?php echo e(__('Entrepôts')); ?>

                      </a>
                      <a wire:navigate href="<?php echo e(route('inventory.operation-types.index', ['subdomain' => current_company()->domain_name])); ?>" class="dropdown-item">
                        <?php echo e(__("Types d'opérations")); ?>

                      </a>
                      <?php if(storage_locations()): ?>
                      <a wire:navigate href="<?php echo e(route('inventory.locations.index', ['subdomain' => current_company()->domain_name])); ?>" class="dropdown-item">
                        <?php echo e(__('Emplacements')); ?>
                ...
                <div class="dropend">
                    ...
                    <div class="dropdown-menu">
                      <a wire:navigate href="<?php echo e(route('inventory.products.categories.index', ['subdomain' => current_company()->domain_name])); ?>" class="dropdown-item">
