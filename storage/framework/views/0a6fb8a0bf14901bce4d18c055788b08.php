                ...
                <div class="k_field_widget k_field_radio k_light_label ps-3">
                    <div class="k_horizontal">
                        <div class="form-check k_radio_item">
                            <input type="radio" class="form-check-input k_radio_input" wire:model="<?php echo e($value->model); ?>" name="<?php echo e($value->model); ?>" value="multiple" id="multiple" />
                        ...
                        <div class="form-check k_radio_item">
                            <input type="radio" class="form-check-input k_radio_input" wire:model="<?php echo e($value->model); ?>" name="<?php echo e($value->model); ?>" value="advanced" id="advanced"/>
...
<?php /**PATH C:\wamp64\www\my-startups\app.koverae\resources\views/components/blocks/boxes/ratio/pricelist.blade.php ENDPATH**/ ?>