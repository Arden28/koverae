...
<li class="nav-item">
    <a class="nav-link kover-navlink" wire:navigate href="<?php echo e(route('settings.general', ['view' => 'general', 'subdomain' => current_company()->domain_name])); ?>" style="margin-right: 5px;">
      <span class="nav-link-title">
