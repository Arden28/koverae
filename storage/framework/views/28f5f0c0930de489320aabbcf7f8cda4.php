        ...
        <div class="card-body" id="cart-body">
            <div>
                ...
                <div class="order-container-bg-view d-print-none overflow-y-auto flex-grow-1 d-flex flex-column text-start">
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $this->order->details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $cart_item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <ul>
                            ...
                            <div class="d-flex">
                                <div class="product-name w-75 d-inline-block flex-grow-1 fw-bolder pe-1 text-truncate">
                                    <span class="text-wrap">
                                        <?php echo e($cart_item->product->product_name); ?>

                                    </span>
                                </div>
                                <div class="product-price w-25 d-inline-block text-end price fw-bolder">
                                    <?php echo e(format_currency($cart_item->sub_total / 100)); ?>

                                </div>
                            </div>
                            <ul>
                                <li class="price-per-unit">
                                    <em class="qty fst-normal fw-bolder me-1"><?php echo e($cart_item->quantity); ?> </em> <?php echo e(__('Unité(s)')); ?> x <?php echo e(format_currency($cart_item->unit_price / 100)); ?>

                                </li>
                                <!--[if BLOCK]><![endif]--><?php if($this->qty_refund): ?>
                ...
                <div class="empty-cart d-flex flex-column align-items-center justify-content-center text-muted" style="height: 45vh;">
                    ...
                    <br>
                    <h3>
                        <?php echo e(__('Selectionnez une commande')); ?>
                ...
                <div class="order-summary w-100 py-2 px-3 bg-100 text-end fw-bolder fs-2 lh-sm">
                    Total: <span class="total"><?php echo e(format_currency($order->total_amount / 100)); ?></span>
...
<?php /**PATH C:\wamp64\www\my-startups\app.koverae\Modules/Pos\Resources/views/livewire/display/refund.blade.php ENDPATH**/ ?>