...
<html lang="fr">
    <head>
        ...
        <title><?php echo e(__('Devis')); ?> - <?php echo e($quotation->reference); ?> | <?php echo e(current_company()->name); ?></title>
        <!-- Favicon -->
    ...
    <body>
                ...
                <tr>
                    ...
                    <td class="border-0 pl-0" width="50%">
                        <h4 class="text-uppercase cool-gray">
                            <strong><?php echo e(__('Devis')); ?> # <?php echo e($quotation->reference); ?></strong>
                        </h4>
                        <p><?php echo e(__('Date du devis')); ?>: <strong><?php echo e(\Carbon\Carbon::parse($quotation->date)->format('d/m/Y')); ?></strong></p>
                        <p><?php echo e(__("Date d'échéance")); ?>: <strong><?php echo e(\Carbon\Carbon::parse($quotation->expected_date)->format('d/m/Y')); ?></strong></p>
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <table class="table table-items">
                    <thead>
                        <tr>
                            ...
                            <?php if($quotation->product_discount_percentage): ?>
                                <th scope="col" class="text-right border-0"><?php echo e(__('Réduction')); ?></th>
                            <?php endif; ?>
                            <?php if($quotation->tax_percentage): ?>
                    ...
                    <tbody>
                        ...
                        <?php $__currentLoopData = $quotation->quotationDetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td class="pl-0">
                            ...
                            <?php if($quotation->product_discount_amount): ?>
                                <td class="text-right">
                                    <?php echo e(format_currency($item->product_discount_amount)); ?>
                            ...
                            <td class="text-right pr-0">
                                <?php echo e(format_currency($item->sub_total)); ?>

                            </td>
                        </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        
                        <?php if($quotation->discount_amount): ?>
                            <tr>
                                <td colspan="<?php echo e($quotation->table_columns - 2); ?>" class="border-0"></td>
                                <td class="text-right pl-0"><?php echo e(__('Réduction')); ?> (<?php echo e($quotation->discount_percentage); ?>)%</td>
                                <td class="text-right pr-0">
                                    <?php echo e(format_currency($quotation->discount_amount)); ?>

                                </td>
                            </tr>
                        <?php endif; ?>
                        <?php if($quotation->tax_amount): ?>
                            <tr>
                                <td colspan="<?php echo e($quotation->table_columns - 2); ?>" class="border-0"></td>
                                <td class="text-right pl-0"><?php echo e(__('Taxe')); ?>  (<?php echo e($quotation->tax_percentage); ?>%)</td>
                                <td class="text-right pr-0">
                                    <?php echo e(format_currency($quotation->tax_amount)); ?>

                                </td>
                            </tr>
                        <?php endif; ?>
                        <?php if($quotation->tax_rate): ?>
                            <tr>
                                ...
                                <td class="text-right pr-0">
                                    <?php echo e($quotation->tax_percentage); ?>%
                                </td>
                            </tr>
                        <?php endif; ?>
                        <?php if($quotation->shipping_amount): ?>
                            <tr>
                                <td colspan="<?php echo e($quotation->table_columns - 2); ?>" class="border-0"></td>
                                <td class="text-right pl-0"><?php echo e(__('Livraison')); ?></td>
                                <td class="text-right pr-0">
                                    <?php echo e(format_currency($quotation->shipping_amount)); ?>
                        ...
                        <?php endif; ?>
                            <tr>
                                <td colspan="<?php echo e($quotation->table_columns - 2); ?>" class="border-0"></td>
                                <td class="text-right pl-0"><?php echo e(__('Grand Total')); ?></td>
                                <td class="text-right pr-0 total-amount">
                                    <?php echo e(format_currency($quotation->total_amount)); ?>
                ...
                <?php if($quotation->term): ?>
                    <p>
                        <?php echo e(__('Notes')); ?>: <?php echo $quotation->term; ?>

                    </p>
                <?php endif; ?>

                <p>
                    Délai de paiement: <?php echo e(payment_term($quotation->payment_term)); ?>

                </p>
                <?php if($quotation->shipping_date): ?>
                <p>
                    Date de livraison prévue: <?php echo e(\Carbon\Carbon::parse($quotation->shipping_date)->format('d/m/Y')); ?>
...
<?php /**PATH C:\wamp64\www\my-startups\app.koverae\Modules/Sales\Resources/views/print-quotation.blade.php ENDPATH**/ ?>