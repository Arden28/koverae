<?php $__env->startSection('title', 'Log in to your Koverae account'); ?>

<?php $__env->startSection('content'); ?>
<div class="shadow k_website_login card">
    <span class="mx-auto h-100 k_logo" style="background-image: url('<?php echo e(asset('assets/images/logo/logo-black.png')); ?>'); background-size: cover;"></span>
    <div class="card-body">
        <div class="text-center k-alert alert-info">
            <p>
                <?php echo e(__('Access and manage your instances from this Koverae account.')); ?>
...
<?php endif; ?>
            ...
            <div class="clearfix gap-1 pt-3 mb-1 text-center k_login_buttons d-grid">
                <button class="btn btn-primary float-start text-uppercase">
                    <?php echo e(__('Konnect In')); ?>

                </button>

                <div class="links-container">
                    <a href="https://koverae.com/?utm_source=koverae&utm_medium=platform&utm_campaign=self" target="__blank" class="login-link"><?php echo e(__("You are not a Kover ?")); ?></a>
                    <?php if(Route::has('password.request')): ?>
                    <a href="<?php echo e(route('password.request')); ?>" class="reset-link"><?php echo e(__('You forgot your password ?')); ?></a>
                    <?php endif; ?>
                </div>
            </div>
        </form>
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\My Laravel Startup\koverae\resources\views/auth/login.blade.php ENDPATH**/ ?>