...
?>
<!-- Routes -->
<!--[if BLOCK]><![endif]--><?php if($this->can_be_purchased && module('purchase')): ?>
<div class="form-check k_radio_item" id="capsule">
    ...
    <a style="text-decoration: none;" title="<?php echo e($value->help); ?>" wire:navigate href="#" >
        ...
        <span class="stat_value d-none d-lg-flex">
            <?php echo e($bought ?? "0,00"); ?> <?php echo e($unit->name); ?>

        </span>
    </a>
</div>
<?php endif; ?><!--[if ENDBLOCK]><![endif]-->
<?php /**PATH D:\My Laravel Startup\koverae\resources\views/components/capsules/product/bought.blade.php ENDPATH**/ ?>