...
<html lang="fr">
    <head>
        ...
        <title><?php echo e(__('Commande')); ?> - <?php echo e($sale->reference); ?> | <?php echo e(current_company()->name); ?></title>
        <!-- Favicon -->
    ...
    <body>
                ...
                <tr>
                    ...
                    <td class="border-0 pl-0" width="50%">
                        <h4 class="text-uppercase cool-gray">
                            <strong><?php echo e(__('Devis')); ?> # <?php echo e($sale->reference); ?></strong>
                        </h4>
                        <p><?php echo e(__('Date du devis')); ?>: <strong><?php echo e(\Carbon\Carbon::parse($sale->date)->format('d/m/Y')); ?></strong></p>
                        <p><?php echo e(__("Date d'échéance")); ?>: <strong><?php echo e(\Carbon\Carbon::parse($sale->expected_date)->format('d/m/Y')); ?></strong></p>
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <table class="table table-items">
                    <thead>
                        <tr>
                            ...
                            <?php if($sale->product_discount_percentage): ?>
                    ...
                    <tbody>
                        ...
                        <?php $__currentLoopData = $sale->saleDetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td class="pl-0">
                            ...
                            <?php if($sale->product_discount_amount): ?>
                                <td class="text-right">
                        ...
                        <?php if($sale->discount_amount): ?>
                            <tr>
                                <td colspan="<?php echo e($sale->table_columns - 2); ?>" class="border-0"></td>
                                <td class="text-right pl-0"><?php echo e(__('Réduction')); ?> (<?php echo e($sale->discount_percentage); ?>)%</td>
                                <td class="text-right pr-0">
                                    <?php echo e(format_currency($sale->discount_amount)); ?>

                                </td>
                            </tr>
                        <?php endif; ?>
                        <?php if($sale->tax_amount): ?>
                            <tr>
                                <td colspan="<?php echo e($sale->table_columns - 2); ?>" class="border-0"></td>
                                <td class="text-right pl-0"><?php echo e(__('Taxe')); ?>  (<?php echo e($sale->tax_percentage); ?>%)</td>
                                <td class="text-right pr-0">
                                    <?php echo e(format_currency($sale->tax_amount)); ?>

                                </td>
                            </tr>
                        <?php endif; ?>
                        <?php if($sale->tax_rate): ?>
                            <tr>
                                ...
                                <td class="text-right pr-0">
                                    <?php echo e($sale->tax_percentage); ?>%
                                </td>
                            </tr>
                        <?php endif; ?>
                        <?php if($sale->shipping_amount): ?>
                            <tr>
                                ...
                                <td class="text-right pr-0">
                                    <?php echo e(format_currency($sale->shipping_amount)); ?>
                ...
                <?php if($sale->term): ?>
                    <p>
                        <?php echo e(__('Notes')); ?>: <?php echo $sale->term; ?>

                    </p>
                <?php endif; ?>

                <p>
                    Délai de paiement: <?php echo e(payment_term($sale->payment_term)); ?>

                </p>
                <?php if($sale->shipping_date): ?>
                <p>
                    Date de livraison prévue: <?php echo e(\Carbon\Carbon::parse($sale->shipping_date)->format('d/m/Y')); ?>
...
<?php /**PATH D:\My Laravel Project\koverae-app\Modules/Sales\Resources/views/print-sale.blade.php ENDPATH**/ ?>