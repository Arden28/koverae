...
[$__name, $__params] = $__split('manufacturing::cart.m-o-component-cart', ['cartInstance' => 'order','order' => $this->order]);

$__html = app('livewire')->mount($__name, $__params, 'lw-2013101802-0', $__slots ?? [], get_defined_vars());
