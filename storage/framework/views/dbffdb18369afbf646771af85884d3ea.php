<div class="d-flex flex-column flex-md-row flex-fill align-items-stretch align-items-md-center">
        ...
        <div class="dropdown-menu">
            <div class="dropdown-menu-columns">
                ...
                <div class="dropdown-menu-column">
                    <a class="dropdown-item" wire:navigate href="<?php echo e(route('employee.index', ['subdomain' => current_company()->domain_name, 'menu' => current_menu()])); ?>">
                        <?php echo e(__('Employés')); ?>
    ...
    <li class="nav-item" data-turbolinks>
        <a class="nav-link kover-navlink" wire:navigate style="margin-right: 5px;" href="<?php echo e(route('employee.department.index', ['subdomain' => current_company()->domain_name, 'menu' => current_menu()])); ?>">
          <span class="nav-link-title">
    ...
    <li class="nav-item dropdown" data-turbolinks>
        ...
        <div class="dropdown-menu">
            <div class="dropdown-menu-columns">
                <!-- Left Side -->
                <div class="dropdown-menu-column">
                    <a class="dropdown-item" wire:navigate href="<?php echo e(route('settings.general', ['subdomain' => current_company()->domain_name, 'page' => 'employee', 'menu' => current_menu()])); ?>">
                    ...
                    <div class="dropend">
                        ...
                        <div class="dropdown-menu">
                          ...
                          <a wire:navigate href="<?php echo e(route('employee.workplaces.index', ['subdomain' => current_company()->domain_name, 'menu' => current_menu()])); ?>" class="dropdown-item">
                    ...
                    <div class="dropend">
                        ...
                        <div class="dropdown-menu">
                          <a wire:navigate href="<?php echo e(route('employee.jobs.index', ['subdomain' => current_company()->domain_name, 'menu' => current_menu()])); ?>" class="dropdown-item">
