        ...
        <div class="dropdown-menu">
            <div class="dropdown-menu-columns">
                ...
                <div class="dropdown-menu-column">
                    <a wire:navigate href="<?php echo e(route('manufacturing.orders.index', ['subdomain' => current_company()->domain_name, 'menu' => current_menu()])); ?>" class="dropdown-item">
                      <?php echo e(__('Ordres de fabrications')); ?>

                    </a>
                    <a wire:navigate href="<?php echo e(route('inventory.operation-transfers.index', ['subdomain' => current_company()->domain_name, 'menu' => current_menu()])); ?>" class="dropdown-item">
        ...
        <div class="dropdown-menu">
            <div class="dropdown-menu-columns">
                ...
                <div class="dropdown-menu-column">
                    ...
                    <a class="dropdown-item" wire:navigate href="<?php echo e(route('manufacturing.boms.index', ['subdomain' => current_company()->domain_name, 'menu' => current_menu()])); ?>">
