<div>
    ...
    <div class="table-responsive card">
        <table class="table card-table table-vcenter text-nowrap datatable">
            <thead>
                <tr>
                    <th><button class="table-sort" data-sort="sort-name"><?php echo e(__('Produit')); ?></button></th>
                    <th><button class="table-sort" data-sort="sort-name"><?php echo e(__('Emplacement')); ?></button></th>
                    <th><button class="table-sort" data-sort="sort-name"><?php echo e(__('Quantité à consommer')); ?></button></th>
                    <th><button class="table-sort" data-sort="sort-name"><?php echo e(__('UdM')); ?></button></th>
                    <th><button class="table-sort" data-sort="sort-name"><?php echo e(__('Consommé')); ?></button></th>
                    <th></th>
                </tr>
            </thead>
            <tbody>
...
unset($__errorArgs, $__bag); ?> <!--[if ENDBLOCK]><![endif]-->
                    ...
                    <td class="k_field_list">
                        <input type="text" wire:model.defer="inputs.<?php echo e($key); ?>.location" class="k_input disabled">
                    </td>
                    <td class="k_field_list">
                        <input type="number" wire:model.blur="inputs.<?php echo e($key); ?>.quantity" class="k_input">
                    </td>
                    <td class="k_field_list">
                        <input type="number" wire:model.blur="inputs.<?php echo e($key); ?>.quantity" class="k_input disabled">
                    </td>
                    <td class="k_field_list">
                        <input type="number" wire:model.blur="inputs.<?php echo e($key); ?>.quantity" class="k_input disabled">
                    </td>
                    <td class="k_field_list">
                         <?php echo e($inputs[$key]['product']); ?> : <?php echo e($inputs[$key]['quantity'] * 50); ?>
