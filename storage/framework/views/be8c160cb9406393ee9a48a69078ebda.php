<?php $__env->startSection('title', $name ?? __('Nouveau Contact')); ?>
<div>
...
unset($__errorArgs, $__bag); ?> <!--[if ENDBLOCK]><![endif]-->
                        ...
                        <!-- Job Title -->
                        <!--[if BLOCK]><![endif]--><?php if(!$is_company): ?>
                            <h2 wire:transition>
...
unset($__errorArgs, $__bag); ?> <!--[if ENDBLOCK]><![endif]-->
                ...
                <div class="k_notebokk_headers">
                    ...
                    <ul class="nav nav-tabs flex-row flex-nowrap" data-bs-toggle="tabs">
                        ...
                        <!--[if BLOCK]><![endif]--><?php if($is_company): ?>
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="tab" href="#fiscal"><?php echo e(__('Informations Fiscales')); ?></a>
                        </li>
                        <?php endif; ?> <!--[if ENDBLOCK]><![endif]-->
                        <li class="nav-item">
...
<?php /**PATH C:\wamp64\www\my-startups\app.koverae\Modules/Contact\Resources/views/livewire/contact/create.blade.php ENDPATH**/ ?>