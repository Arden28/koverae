    ...
    <div class="k_cell k_wrap_input flex-grow-1">
        <div class="k_field_widget k_field_boolean">
            <div class="k-checkbox form-check d-inline-block">
                <input type="<?php echo e($value->type); ?>" wire:model="<?php echo e($value->model); ?>" class="form-check-input" style="color: #0E6163" id="<?php echo e($value->model); ?>" onclick="checkStatus(this)">
            </div>
        </div>
...
<?php /**PATH C:\wamp64\www\my-startups\app.koverae\resources\views/components/inputs/checkbox/simple.blade.php ENDPATH**/ ?>