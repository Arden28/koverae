        ...
        <table class="table card-table table-vcenter text-nowrap datatable">
            <thead>
                <tr>
                    ...
                    <th><button class="table-sort"><?php echo e(__('Date Prévue')); ?></button></th>
                    <th><button class="table-sort"><?php echo e(__("Date D'échéance")); ?></button></th>
                    <th><button class="table-sort"><?php echo e(__('Demande')); ?></button></th>
                    <th></th>
                </tr>
            </thead>
            <tbody>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                    ...
                    <td class="k_field_list">
                        <input type="text" wire:model.blur="inputs.<?php echo e($key); ?>.description" class="k_input" id="cart-input">
                    </td>
                    <td class="k_field_list">
                        <input type="datetime-local" wire:model.blur="inputs.<?php echo e($key); ?>.schedule_date" class="k_input" id="cart-input">
                    </td>
                    <td class="k_field_list">
                        <input type="datetime-local" wire:model.blur="inputs.<?php echo e($key); ?>.deadline_date" class="k_input">
                    </td>
                    <td class="k_field_list">
                        <input type="number" wire:model.blur="inputs.<?php echo e($key); ?>.demand" class="k_input">
                    </td>
...
<?php /**PATH C:\wamp64\www\my-startups\app.koverae\Modules/Inventory\Resources/views/livewire/cart/operation-detail-cart.blade.php ENDPATH**/ ?>