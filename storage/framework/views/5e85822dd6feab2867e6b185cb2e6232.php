                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row g-2 align-items-center">
                                ...
                                <div class="col-auto">
                                    <a wire:navigate href="<?php echo e(route('inventory.operation-transfers.index', ['subdomain' => current_company()->domain_name, 'type' => $o->id,'status' => 'ready', 'menu' => current_menu()])); ?>" class="btn btn-primary">
                                         <?php echo e($o->operationTransfers()->isOperationType($o->id)->isWating()->count()); ?> <?php echo e(__('à traiter')); ?>

                                    </a>
                                </div>
                                <?php if($o->operationTransfers()->isOperationType($o->id)->isWating()->isLate()->count() >= 1 ): ?>
                                    <div class="col-auto">
