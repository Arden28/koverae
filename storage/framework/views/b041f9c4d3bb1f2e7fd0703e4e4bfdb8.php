        ...
        <div class="container-xl">
          <ul class="navbar-nav">
            ...
            <li class="nav-item" data-turbolinks>
                <a class="btn" wire:navigate style="margin-right: 5px;" href="<?php echo e(route('dashboards.index', ['subdomain' => current_company()->domain_name])); ?>">
                  <span class="nav-link-title">
                ...
                <div class="dropdown-menu">
                    <div class="dropdown-menu-columns">
                        ...
                        <div class="dropdown-menu-column">
                            <a class="dropdown-item" wire:navigate href="<?php echo e(route('dashboards.lists', ['subdomain' => current_company()->domain_name])); ?>">
