...
<div class="d-flex" style="margin-bottom: 8px;">
    ...
    <div class="k_cell k_wrap_input flex-grow-1">
        <input type="<?php echo e($value->type); ?>" wire:model="<?php echo e($value->model); ?>" placeholder="<?php echo e($value->placeholder); ?>" class="k_input" id="date_0">
...
<?php /**PATH C:\wamp64\www\my-startups\app.koverae\resources\views/components/inputs/input-2.blade.php ENDPATH**/ ?>