...
$__html = app('livewire')->mount($__name, $__params, 'lw-486372177-0', $__slots ?? [], get_defined_vars());
...
[$__name, $__params] = $__split('inventory::table.physical-inventory-table', []);

$__html = app('livewire')->mount($__name, $__params, 'lw-486372177-1', $__slots ?? [], get_defined_vars());
