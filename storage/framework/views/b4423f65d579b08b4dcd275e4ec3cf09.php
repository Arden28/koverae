                ...
                <div class="k_settings_box col-12 col-lg-6 k_searchable_setting">
                    ...
                    <div class="k_setting_right_pane">
                        <div class="mt12">
                            ...
                            <br>
                            <a wire:navigate href="<?php echo e(route('settings.users', ['subdomain' => current_company()->domain_name, 'menu' => current_menu()])); ?>" class="btn btn-link k_web_settings_access_rights outline-none">
            ...
            <div class="row mt16 k_settings_container">
                ...
                <div class="k_settings_box col-12 col-lg-6 k_searchable_setting">
                    ...
                    <div class="k_setting_right_pane">
                        ...
                        <!--[if BLOCK]><![endif]--><?php if($this->has_all_rights_access): ?>
                        <div class="mt14">
                            <button class="btn btn-link k_web_settings_access_rights">
                                <i class="bi bi-arrow-right k_button_icon"></i> <span>Droits d'accès par défaut</span>
                            </button>
...
<?php /**PATH D:\My Laravel Project\koverae-app\Modules/Settings\Resources/views/livewire/module/general.blade.php ENDPATH**/ ?>