...
<div class="d-flex" style="margin-bottom: 8px;">
    ...
    <div class="k_cell k_wrap_input flex-grow-1">
        <span class="cursor-pointer" style="color: #017e84; font-weight: 500;" id="date_0"><?php echo e(\Modules\Contact\Entities\Contact::find($this->customer ?? $this->supplier)->name); ?></span>
    </div>
</div>
<?php else: ?>
<div class="d-flex" style="margin-bottom: 8px;">
...
<?php /**PATH C:\wamp64\www\my-startups\app.koverae\resources\views/components/inputs/select/readonly/contact.blade.php ENDPATH**/ ?>