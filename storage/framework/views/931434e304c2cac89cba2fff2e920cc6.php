...
[$__name, $__params] = $__split('inventory::navbar.control-panel.operation-transfer-form-panel', ['transfer' => $transfer]);

$__html = app('livewire')->mount($__name, $__params, '5yNFT4t', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'hEzjBTm', $__slots ?? [], get_defined_vars());
